...
const defaultServices: Service[] = [
  ...
  },
  {
    ...
    description: 'Produção completa e impecável de maquiagem para o grande dia, garantindo durabilidade máxima sob luzes e emoções fortes.',
    benefits: ['Teste e prova antecipada', 'Blindagem à prova de lágrimas', 'Iluminação profissional HD', 'Cílios e preparo da pele premium'],
    duration: '2h30',
    price: 600,
    category: 'Beleza',
  },
  {
    ...
    description: 'Técnica avançada que proporciona olhar marcante, dramático e perfeitamente preenchido com fios leves e seguros.',
    benefits: ['Volume intenso sem pesar', 'Manutenção a cada 20 dias', 'Olhar expressivo logo ao acordar', 'Material seguro e hipoalergênico'],
    duration: '2h',
    price: 220,
    category: 'Estética',
  },
  {
    ...
    description: 'Procedimento estético que devolve o contorno natural, a cor e a vivacidade aos lábios com efeito natural (Aquarela Lips).',
    benefits: ['Boca com aparência levemente corada', 'Correção de assimetrias sutis', 'Estimulação de colágeno (revitalização)', 'Duração média de 1 a 2 anos'],
    duration: '2h30',
    price: 550,
    category: 'Estética',
  },
  {
    id: '17',
    name: 'Limpeza de Pele Profunda Facial',
    description: 'Remoção minuciosa de impurezas, cravos e células mortas, seguida de tonificação e máscara calmante/hidratante.',
    benefits: ['Pele renovada e respirando livremente', 'Controle da oleosidade excessiva', 'Prevenção do envelhecimento precoce', 'Extração profissional sem marcas'],
    duration: '1h30',
    price: 180,
    category: 'Tratamento',
  },
  {
    id: '18',
    name: 'Terapia Capilar Antiqueda',
    description: 'Tratamento intensivo no couro cabeludo utilizando alta frequência, blend de óleos essenciais e estimulação focada.',
    benefits: ['Fortalecimento do folículo piloso', 'Melhora da circulação e oxigenação', 'Redução drástica da queda capilar', 'Trata casca e descamações'],
    duration: '1h15',
    price: 260,
    category: 'Tratamento',
  }
